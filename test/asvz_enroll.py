...
def asvz_enroll():
    ...
    try:
        ...
        day_ele = driver.find_element(By.XPATH, "//div[@class='teaser-list-calendar__day'][contains(., '" + day + "')]")
        # search in day div after corresponding location and time
        day_ele.find_element(By.XPATH, ".//li[@class='btn-hover-parent'][contains(., '" + facility + "')][contains(., '" + lesson_time + "')]").click()
        ...
        # choose organization:
        organization = driver.find_element(By.XPATH, "//input[@id='userIdPSelection_iddtext']")
